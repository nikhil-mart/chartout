...
public class SingleSpinnerSearch extends android.support.v7.widget.AppCompatSpinner implements
    OnCancelListener {
  ...
  public void onCancel(DialogInterface dialog) {
    ...
    ArrayAdapter<String> adapterSpinner = new ArrayAdapter<>(getContext(), R.layout.spinner_item,
        ...
        public void onClick(View v) {
          ...
          for (int i = 0; i < len; i++) {
            ...
            if (i == position) {
              ...
              Log.i(TAG,
                  "On Click Selected Item : " + arrayList.get(i).getName() + " : " + arrayList
                      .get(i).isSelected());
            }
          }
          ad.dismiss();
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
          ...
          if (mOriginalValues == null) {
            mOriginalValues = new ArrayList<>(
                arrayList); // saves the original data in mOriginalValues
          }
          ...
          if (constraint == null || constraint.length() == 0) {
            ...
            for (int i = 0; i < mOriginalValues.size(); i++) {
              Log.i(TAG,
                  "Filter : " + mOriginalValues.get(i).getName() + " -> " + mOriginalValues.get(i)
                      .isSelected());
