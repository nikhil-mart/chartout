...
//    mOnClickListener.onClick(mButtons[item]);
  ...
  /**
   * get small label at position Each item has tow label, one is large, another is small.
   */
  ...
  /**
   * get large label at position Each item has tow label, one is large, another is small.
   */
  ...
  /**
   * set all item small TextView size Each item has tow label, one is large, another is small. Small one will be shown when item state is normal Large
   * one will be shown when item checked.
   */
  ...
  /**
   * set all item large TextView size Each item has tow label, one is large, another is small. Small one will be shown when item state is normal.
  ...
  /**
   * set all item large and small TextView size Each item has tow label, one is large, another is small. Small one will be shown when item state is
   * normal Large one will be shown when item checked.
   */
  ...
  /**
   * This method will link the given ViewPager and this BottomNavigationViewEx together so that changes in one are automatically reflected in the
   * other. This includes scroll state changes and clicks.
   */
  ...
  /**
   * A {@link ViewPager.OnPageChangeListener} class which contains the necessary calls back to the provided {@link BottomNavigationViewEx} so that the
   * tab position is kept in sync. <p> <p>This class stores the provided BottomNavigationViewEx weakly, meaning that you can use {@link
   * ViewPager#addOnPageChangeListener(ViewPager.OnPageChangeListener) addOnPageChangeListener(OnPageChangeListener)} without removing the listener
   * and not cause a leak.
   */
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
  ...
  private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
    ...
    MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomNavigationViewEx bnve, boolean smoothScroll,
